...
public class ModificarSitio extends Activity {
    ...
    String obtenerPath;
    String name = obtenerPath;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_modificar_sitio);
        ...
        Intent obtenerModificar = getIntent();
        titulo.setText(obtenerModificar.getExtras().getString("nombre"));
        titulo.setEnabled(false);
        obtenerPath = obtenerModificar.getExtras().getString("foto");
        iv.setImageBitmap(BitmapFactory.decodeFile(obtenerPath));

        direccion.setText(obtenerModificar.getExtras().getString("direccion"));
        email.setText(obtenerModificar.getExtras().getString("email"));
        telefono.setText(obtenerModificar.getExtras().getString("telefono"));
        valoracion.setText(obtenerModificar.getExtras().getString("valoracion"));
        comentario.setText(obtenerModificar.getExtras().getString("comentarios"));
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.update("sitio",a,"nombre = ?", new String[]{titulo.getText().toString()});
                Toast.makeText(ModificarSitio.this, "El sitio " + titulo.getText().toString() + " ha sido modificado", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.modificar_sitio, menu);
        return true;
    }
